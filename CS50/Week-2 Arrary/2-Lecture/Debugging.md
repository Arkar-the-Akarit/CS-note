...
step in - breakpoint set ထားတဲ့အတွင်းထဲက detail ကျကျ ဖြစ်သွားတာတွေကိုပြ e.g. program မှာဆိုရင် get_int() ဆိုတဲ့ function သာပါနေရင် အဲ့အတွင်းထဲထိဘာတွေဖြစ်နေလဲပြ
